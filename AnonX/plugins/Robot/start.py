        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/Adrish_Support) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
⏳ **𝗗𝘂𝗿𝗮𝘁𝗶𝗼𝗻:-** {duration} ᴍɪɴᴜᴛᴇs
👀 **𝗩𝗶𝗲𝘄 :-** `{views}`
⏰ **𝗣𝘂𝗯𝗹𝗶𝘀𝗵𝗲𝗱 𝗯𝘆:-** {published}
🎥 **𝗖𝗵𝗮𝗻𝗻𝗲𝗹 :-** {channel}
📎 **𝗖𝗵𝗮𝗻𝗻𝗲𝗹 𝗟𝗶𝗻𝗸 :-** [ᴠɪsɪᴛ ᴄʜᴀɴɴᴇʟ]({channellink})
🔗 **𝗟𝗶𝗻𝗸 :-** [ᴡᴀᴛᴄʜ ᴏɴ ʏᴏᴜᴛᴜʙᴇ]({link})
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/Adrish_Support"
                        ),
                    ],
                ]
            )
